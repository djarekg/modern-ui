...
import { stringConverter } from '@mui/core';

import { redispatchEvent } from '../events/redispatch-event.js';
import styles from './text-field.css.js';
 ...
 * @cssprop --mui-text-field-border-color - The color of the text field's border. Default is `#ffffff`.
 *
 * A text field component.
 */
@customElement('mui-text-field')
export class TextField extends LitElement {
  static override styles = [styles];

  @property({ reflect: true }) appearance: AppearceType = 'standard';

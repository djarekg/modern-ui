...
export class List extends LitElement {
  ...
  @queryAssignedElements({ flatten: true, selector: '[mui-list-item]' }) items!: ListItem[];

  @query('mui-list') listRoot!: HTMLElement;
  ...
  protected renderList(): TemplateResult {
    return html`
      <ul
        ...
        class="mui-list ${classMap(this.getRenderListClasses())}"
